        ...
        <div class="flex justify-between h-16">
            <div class="flex justify-between w-full">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                       <a href="{{ route('track-parsel-form') }}"> <x-primary-button> <i class="mr-2 text-white fa-solid fa-magnifying-glass"></i> Track Parsel</x-primary-button></a>
                    </div>
                </div>
                ...
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('parcels')" :active="request()->routeIs('parcels')">
                            {{ __('পার্সেল') }}
                        </x-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
            ...
            <!-- Settings Dropdown -->
            <div class="hidden sm:flex sm:items-center sm:ml-6 min-w-fit">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <div class="flex items-center">
                            <img class="object-cover w-10 h-10 rounded-full" src="{{ url('storage/'.auth()->user()->avatar) }}" alt="">
