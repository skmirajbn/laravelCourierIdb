...
<body>
    <main>
        <header class="container flex">
            <div class="flex w-1/2 gap-16 py-4">
            ...
            <div class="flex items-center justify-end w-1/2 gap-6">
                <p> <i class="text-red-600 fa-solid fa-phone"></i> কল করুন ০৯৬১০০০৭৩৩৯</p>
                <a href="{{url('/login')}}" class="px-8 py-2 border-2 border-red-600 rounded-lg">লগ ইন</a>
            ...
            <div class="flex">
                <div class="relative w-2/3">
                    <div class="pb-6">
                        ...
                        <div class="absolute w-full px-20 text-white -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 text-7xl">
                            <h1 class="font-medium">দেশজুড়ে সবচেয়ে বেশি রাইডার</h1>
                            <h1 class="font-bold text-red-600">৩৫০০+ ফ্রন্টলাইনার</h1>
                        </div>
                    </div>
                </div>
                <div class="flex items-center justify-center w-1/3 text-white bg-black rounded-bl-3xl">
                    <form action="{{route('register')}}">
                        <div class="space-y-3">
                            <h3 class="text-center">বিনামূল্যে সাইন আপ করুন মাত্র দুই মিনিটে</h3>
                            <div class="flex px-2 overflow-hidden bg-white border-2 border-red-500 rounded-md">
                                <h3 class="flex items-center text-black bg-white">
                                    <div class="flex items-center justify-center w-6 h-4 bg-green-600">
                                        <div class="w-2 h-2 bg-red-600 rounded-full"></div>
                                    </div>
                                    +88
                                </h3>
                                <input class="w-full p-2 text-black border-none focus:border-none" placeholder="ফোন নাম্বার" type="text" name="phone">
                            ...
                            <button type="submit" class="block w-full py-2 text-center bg-red-600 rounded-lg">সাইন আপ</button>
                            <h3 class="text-center">অথবা,</h3>
                            <h2 class="text-center">ট্রাক মুভমেন্ট স্ট্যাটাস</h2>
                            <div class="flex pl-2 overflow-hidden bg-white rounded-md">
                                <input class="w-full p-2 text-black border-none focus:border-none" placeholder="ট্রাকিং আইডি দিন" type="text">
                                <button class="px-6 bg-red-600">ট্রাক</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <section class="container py-10">
            <div class="flex justify-between h-20">
                <img class="object-contain w-20" src="images/brands/ajkerdeal-color.png" alt="">
                <img class="object-contain w-20" src="images/brands/bata-color.png" alt="">
                <img class="object-contain w-20" src="images/brands/daraz-color.png" alt="">
                <img class="object-contain w-20" src="images/brands/lotto-color.png" alt="">
                <img class="object-contain w-20" src="images/brands/othoba-color.png" alt="">
                <img class="object-contain w-20" src="images/brands/rangs-group-color.png" alt="">
            </div>
        </section>
        <section class="container py-10 space-y-12">
            <h2 class="text-4xl font-bold text-center">সার্ভিস সমূহ</h2>
        ...
        <section class="container py-10 space-y-12">
            <h2 class="text-4xl font-bold text-center">আপনার লজিস্টিক পার্টনার হিসেবে REDX বেছে নিন</h2>
            <div class="grid grid-cols-3 gap-16 px-16">
                <div>
                    <img class="mx-auto" src="images/courierFeatures/fastest-delivery.svg" alt="">
                    <h2 class="text-2xl font-bold text-center">৩ দিনে ডেলিভারি গ্যারান্টিড</h2>
        ...
        <section class="py-10 space-y-12 text-white bg-black">
            <div class="container flex px-16 gap-28">
                <div class="w-1/3">
                    <img class="w-full" src="images/bangladash-map.svg" alt="">
                </div>
                <div class="flex items-center w-2/3 px-16">
                    <div class="flex flex-col gap-5">
                        ...
                        <button class="px-10 py-3 bg-red-600 rounded-lg w-fit">কভারেজ এলাকা দেখুন</button>
                    </div>
                </div>
            </div>
        </section>
        <section class="container py-10 space-y-12">
            <h2 class="text-4xl font-bold text-center">ডেলিভারি ক্যালকুলেটর</h2>
            <p>আপনার শিপমেন্টের সুবিধার জন্য আগে থেকেই আপনার ডেলিভারী চার্জ সম্পর্কে ধারণা নিন</p>
            <div class="flex gap-16 px-44">
                <div class="w-1/2 space-y-8">
                    <div class="">
                        <h5>পণ্যের ওজন ( সর্বোচ্চ 10 কেজি )</h5>
                        <input type="text" placeholder="পন্যের ওজন লিখুন" class="w-full max-w-xs input input-bordered" />
                    </div>
                    <div class="">
                        <h5>পিক-আপ এলাকা</h5>
                ...
                <div class="w-1/2 space-y-8">
                    <div class="">
                        ...
                        <input type="text" placeholder="পন্যের বিক্রয়মূল্য লিখুন" class="w-full max-w-xs input input-bordered" />
                    </div>
                    <div class="">
            ...
            <button class="block px-6 py-3 mx-auto font-bold text-white bg-red-600 rounded-lg">ডেলিভারি চার্জ দেখুন</button>
            <p class="text-center">আপনি কি জানতে চান, যেকোনো লোকেশনে আপনার পার্সেল পাঠাতে কত খরচ হতে পারে?<br>
                আমাদের বিস্তারিত <span class="font-bold text-red-600">লিস্টটি দেখুন</span></p>
        </section>
        <section class="container py-10 space-y-12">
            <h2 class="text-4xl font-bold text-center">রেডএক্সের প্রতি গ্রাহকদের ভালোবাসা</h2>
            <div class="flex gap-3">
                <div class="w-1/3 p-6 space-y-2 border border-gray-300">
                    <div class="block"><button class="px-2 py-1 bg-gray-300">SME</button></div>
                    <i class="text-4xl text-red-600 fa-solid fa-quote-left"></i>
        ...
        <section class="container py-10 space-y-12">
            <h2 class="text-4xl font-bold text-center">আপনার সকল জিজ্ঞাসা</h2>
            <p class="font-bold text-center">সর্বাধিক জিজ্ঞাসিত প্রশ্নগুলি দেখুন, যেকোনো প্রয়োজনে আমরা আপনার পাশে আছি</p>
        ...
        <section class="container flex items-center gap-6 px-16 py-12 text-white bg-black">
            <div class="w-1/2">
                <div class="mx-auto">
            ...
            <div class="w-1/2">
                <button class="block px-12 py-4 mx-auto bg-red-600 rounded-lg w-fit">সাইন-আপ কারুন</button>
            </div>
        </section>
        <section class="container py-20 space-y-12">
          <h2 class="text-4xl font-bold text-center">মিডিয়াতে রেডএক্স</h2>
        ...
        <footer class="bg-gray-100 py-28">
            <div class="container flex justify-between gap-10 px-16">
                <div class="space-y-5">
