        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex gap-8">
                <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="flex gap-10 px-4 py-10">
                            <img class="object-contain w-16" src="{{ url('images/others/createparcel.png') }}"
                                alt="">
                            <div class="space-y-2">
                ...
                <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="flex gap-10 px-4 py-10">
                            <img class="object-contain w-16" src="{{ url('images/others/credit.svg') }}" alt="">
                            <div class="space-y-2">
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex gap-8">
                <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="flex gap-10 px-4 py-10">
                            <i class="text-5xl fa-solid fa-shop"></i>
                            <div class="space-y-2">
                                <h3 class="text-2xl font-bold">শপ তৈরী করুন</h3>
                                <p>আমাদের রাইডাররা আপনার পার্সেল আপনার পছন্দসই লোকেশণে পৌঁছে দিতে প্রস্তুত</p>
                                <a href="{{ route('create-shop') }}"><x-primary-button>Create Shop</x-primary-button></a>
                            </div>
                        </div>
                    </div>
                </div>
